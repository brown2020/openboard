...
import { HomeLowerSections } from "./home-lower-sections";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              aria-label="OpenBoard on GitHub"
                  ...
                  <div className="space-y-3">
                    {["Portfolio", "Latest Project", "YouTube Channel", "Newsletter"].map((item, i) => (
                      <div
                        key={item}
                        className={cn(
                          "p-4 rounded-xl transition-[background-color,transform,box-shadow] duration-300",
