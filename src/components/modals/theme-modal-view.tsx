...
type ThemeModalViewProps = {
  selectedTheme: any; customizing: any; isOpen: any; handleApplyTheme: any; handleCustomColorChange: any; handleBackgroundChange: any; handleSaveCustom: any; handleReset: any; handleClose: any; currentBoard: any; setSelectedTheme: any; setCustomizing: any;
};

export function ThemeModalView({
  selectedTheme, customizing, isOpen, handleApplyTheme, handleCustomColorChange, handleBackgroundChange, handleSaveCustom, handleReset, handleClose, currentBoard, setSelectedTheme, setCustomizing
}: ThemeModalViewProps) {
  return (
      ...
      <SheetContent className="w-full sm:max-w-2xl overflow-y-auto">
        ...
        <div className="space-y-8 mt-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {THEME_PRESETS.map((theme) => (
                <button
                  ...
                  className={cn(
                    "relative p-4 rounded-xl border-2 transition-[border-color,box-shadow,transform] duration-200",
            ...
            <div className="space-y-6 animate-in slide-in-from-top-2 duration-200">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setSelectedTheme((prev: BoardTheme | null) =>
                      prev
                        ? {
                            ...prev,
          ...
          <div>
            ...
            <div
              className="p-6 rounded-xl border transition-[background-color,box-shadow,transform] duration-300"
              style={{
                background:
                  selectedTheme?.background.type === "gradient"
                    ? selectedTheme.background.value
            ...
            >
              ...
              <div
                className="p-4 mt-4 transition-[background-color,box-shadow,transform] duration-300"
                style={{
