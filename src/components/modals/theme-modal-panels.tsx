    ...
    <div className="space-y-6 animate-in slide-in-from-top-2 duration-200">
      <div className="grid grid-cols-2 gap-4">
        <ColorPicker
          ...
          onChange={(value) => handleCustomColorChange("primaryColor", value)}
        />
        <ColorPicker
          label="Text Color"
...
function radiusToCss(radius: BoardTheme["borderRadius"] | undefined): string {
  if (radius === "none") return "0";
  if (radius === "sm") return "0.25rem";
  if (radius === "md") return "0.5rem";
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ background: selectedTheme?.background.value }}
      >
        <h4
        ...
        <p
          ...
          style={{ color: selectedTheme?.textColor }}
        >
          {description || "This is how your board will look"}
        </p>
        <div
          ...
          style={{
            ...
            borderRadius: radiusToCss(selectedTheme?.borderRadius),
          }}
        >
