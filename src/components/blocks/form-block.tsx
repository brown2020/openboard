...
import { FormBlockEditPanel } from "./form-block-edit-panel";
  ...
  if (isEditMode && isEditing) {
    return (
      <FormBlockEditPanel
        ...
        setEditSubmitUrl={setEditSubmitUrl}
        editFields={editFields}
        handleFieldChange={handleFieldChange as (index: number, key: string, value: string | boolean) => void}
